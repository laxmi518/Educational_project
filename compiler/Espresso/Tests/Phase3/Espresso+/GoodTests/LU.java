...
//4.0  3.0  2.0  1.0  
//0.75  1.75  -0.5  1.25  
//0.5  0.8571428571428571  3.4285714285714284  -0.5714285714285714  
//0.25  0.7142857142857142  0.8333333333333334  3.3333333333333335  
import Math;
import System;
...
public class LU {
    ...
    */
    ...
    public static final void insert_copy(double B[][], double A[][]) {
        int M = A.length;
        int N = A[0].length;
